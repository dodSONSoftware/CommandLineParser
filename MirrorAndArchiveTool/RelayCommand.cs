...
//{
//    /// <summary>
//    /// The universal class for all <see cref="ICommand"/> types.
//    /// </summary>
...
//        #region Ctor
//        /// <summary>
//        /// Instantiates a new <see cref="RelayCommand"/> with the provided <see cref="Action{T1}"/> and <see cref="Predicate{T}"/>.
//        /// </summary>
...
//        }
//        /// <summary>
//        /// Instantiates a new <see cref="RelayCommand"/> with the provided <see cref="Action{T1}"/>.
//        /// </summary>
//        /// <param name="execute">The <see cref="Action{T1}"/> to invoke when this command is executed.</param>
//        public RelayCommand(Action<object> execute)
//            : this(execute, null) { }
